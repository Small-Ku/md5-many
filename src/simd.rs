...
///
/// `fearless_simd` 0.5 uses at most 8 lanes for native `u32` vectors (AVX2).
/// Keeping this at 16 leaves room for the planned AVX-512 backend without
/// changing the public batch API.
